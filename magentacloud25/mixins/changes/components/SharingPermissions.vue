	...
	<ul class="sharing-permissions">
		...
		<template v-if="isExteranlShare">
			...
			<template v-if="isFolder && fileHasCreatePermission && config.isPublicUploadEnabled">
				<NcActionRadio :checked="sharePermissions === publicUploadRValue"
				...
				<NcActionRadio :checked="sharePermissions === publicUploadRWValue"
				...
				<NcActionRadio :checked="sharePermissions === publicUploadWValue"
			...
			<template v-else>
				...
				<NcActionRadio :checked="sharePermissions === publicUploadEValue"
...
export default {
	...
	computed: {
		 ...
		 * This allows NcActionRadios to have the same name prop
	...
	methods: {
		...
		addExpirationDate(date) {
			...
			console.log(this.share.expireDate )
		},
